...
class TestVolumeAccessPath(test_objects.BaseObjectsTestCase):
    ...
    @mock.patch('DSpace.db.volume_access_path_create',
    ...
    @mock.patch('DSpace.db.volume_access_path_update')
    ...
    @mock.patch('DSpace.db.sqlalchemy.api.volume_access_path_destroy')
...
class TestAccessPathList(test_objects.BaseObjectsTestCase):
    @mock.patch('DSpace.db.volume_access_path_get_all',
                return_value=[fake_volume_access_path])
