...
class TestNode(NodeCompareTestCase):
    ...
    @mock.patch('DSpace.db.get_by_id', return_value=fake_node)
    ...
    @mock.patch('DSpace.db.node_create', return_value=fake_node)
    ...
    @mock.patch('DSpace.db.node_update')
    ...
    @mock.patch('DSpace.db.sqlalchemy.api.node_destroy')
...
class TestNodeList(NodeCompareTestCase):
    @mock.patch('DSpace.db.node_get_all',
