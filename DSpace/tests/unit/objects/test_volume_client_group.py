...
class TestVolumeClientGroup(test_objects.BaseObjectsTestCase):
    ...
    @mock.patch('DSpace.db.volume_client_group_create',
    ...
    @mock.patch('DSpace.db.volume_client_group_update')
    ...
    @mock.patch('DSpace.db.sqlalchemy.api.volume_client_group_destroy')
...
class TestVolumeClientGroupList(test_objects.BaseObjectsTestCase):
    @mock.patch('DSpace.db.volume_client_group_get_all',
                return_value=[fake_volume_client_group])
