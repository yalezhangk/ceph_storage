...
class TestRack(test_objects.BaseObjectsTestCase):
    ...
    @mock.patch('DSpace.db.get_by_id', return_value=fake_rack)
    ...
    @mock.patch('DSpace.db.rack_create', return_value=fake_rack)
    ...
    @mock.patch('DSpace.db.rack_update')
    ...
    @mock.patch('DSpace.db.sqlalchemy.api.rack_destroy')
...
class TestRackList(test_objects.BaseObjectsTestCase):
    @mock.patch('DSpace.db.rack_get_all',
