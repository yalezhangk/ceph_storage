...
class TestVolumeAccessPath(test_objects.BaseObjectsTestCase):
    ...
    @mock.patch('DSpace.db.volume_client_create',
    ...
    @mock.patch('DSpace.db.volume_client_update')
    def test_save(self, volume_client_update):
        ...
        volume_client.iqn = 'iqn.2019-10.DSpace.net:2990bfd9e03e'
        volume_client.save()
    ...
    @mock.patch('DSpace.db.sqlalchemy.api.volume_client_destroy')
...
class TestVolumeClientList(test_objects.BaseObjectsTestCase):
    @mock.patch('DSpace.db.volume_client_get_all',
                return_value=[fake_volume_client])
