...
class TestCephConfig(test_objects.BaseObjectsTestCase):
    ...
    @mock.patch('DSpace.db.get_by_id', return_value=fake_ceph_config)
    ...
    @mock.patch('DSpace.db.ceph_config_create', return_value=fake_ceph_config)
    ...
    @mock.patch('DSpace.db.ceph_config_update')
    ...
    @mock.patch('DSpace.db.sqlalchemy.api.ceph_config_destroy')
...
class TestCephConfigList(test_objects.BaseObjectsTestCase):
    @mock.patch('DSpace.db.ceph_config_get_all',
                return_value=[fake_ceph_config])
