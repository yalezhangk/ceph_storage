...
def define_tables(meta):
    ...
    node = Table(
        ...
        Column('cluster_ip', InetSmall()),
        Column('public_ip', InetSmall()),
    ...
    disks = Table(
        ...
        Column('serial', String(64)),
        Column('wwid', String(64)),
    ...
    alert_rules = Table(
        ...
        Column('trigger_mode', String(64), default='eq'),
