...
class TestDatacenter(test_objects.BaseObjectsTestCase):
    ...
    @mock.patch('t2stor.db.get_by_id', return_value=fake_datacenter)
    ...
    @mock.patch('t2stor.db.datacenter_create', return_value=fake_datacenter)
    ...
    @mock.patch('t2stor.db.datacenter_update')
    ...
    @mock.patch('t2stor.db.sqlalchemy.api.datacenter_destroy')
...
class TestDatacenterList(test_objects.BaseObjectsTestCase):
    @mock.patch('t2stor.db.datacenter_get_all',
