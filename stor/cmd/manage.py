...
from stor.common import config  # noqa
from stor import context
from stor import db
from stor.db import migration as db_migration
...
class DbCommands(object):
    ...
    def purge(self, age_in_days):
        """Purge deleted rows older than a given age from stor tables."""
