...
from stor.tests.unit import objects as test_objects
...
class TestRPCService(test_objects.BaseObjectsTestCase):
    ...
    @mock.patch('stor.db.get_by_id', return_value=fake_rpc_service)
    ...
    @mock.patch('stor.db.sqlalchemy.api.model_query')
    ...
    @mock.patch('stor.db.rpc_service_create', return_value=fake_rpc_service)
    ...
    @mock.patch('stor.db.rpc_service_update')
    ...
    @mock.patch('stor.db.sqlalchemy.api.rpc_service_destroy')
...
class TestRPCServiceList(test_objects.BaseObjectsTestCase):
    @mock.patch('stor.db.rpc_service_get_all',
