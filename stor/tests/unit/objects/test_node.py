...
class TestNode(NodeCompareTestCase):
    ...
    @mock.patch('stor.db.get_by_id', return_value=fake_node)
    ...
    @mock.patch('stor.db.node_create', return_value=fake_node)
    ...
    @mock.patch('stor.db.node_update')
    ...
    @mock.patch('stor.db.sqlalchemy.api.node_destroy')
...
class TestNodeList(NodeCompareTestCase):
    @mock.patch('stor.db.node_get_all',
